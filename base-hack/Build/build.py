...
file_dict = [
    ...
    File(name="DK Dirt Face", pointer_table_index=TableNames.TexturesGeometry, file_index=0x1379, source_file="assets/displays/dirt_colored.png", texture_format=TextureFormat.RGBA5551),
]
