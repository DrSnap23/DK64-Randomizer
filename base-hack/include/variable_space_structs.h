typedef struct varspace {
	...
	/* 0x058 */ unsigned char k_rool_order[5]; // Order of maps in the K Rool Phase sequence. If K. Rool is being shortened to less than 5 phases, put the unused phases as 0xFF
